...
var G__12795 = o;
(G__12795[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__12797__i < G__12797__a.length) {G__12797__a[G__12797__i] = arguments[G__12797__i + 0]; ++G__12797__i;}
  args = new cljs.core.IndexedSeq(G__12797__a,0);
} 
...
var G__12803 = jsprops;
(G__12803["defaultValue"] = value);

(G__12803["onChange"] = ((function (G__12803,v,value,on_change){
return (function (p1__12801_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12801_SHARP_);
});})(G__12803,v,value,on_change))
);
...
var vec__12810 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12810,(0),null);
var id = cljs.core.nth.call(null,vec__12810,(1),null);
var class$ = cljs.core.nth.call(null,vec__12810,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12815 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12815 == null)){
} else {
var key_12816 = temp__4661__auto___12815;
(jsprops["key"] = key_12816);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12818 = (new reagent.impl.template.NativeWrapper());
(G__12818["name"] = c);
...
var len__7479__auto___12824 = arguments.length;
var i__7480__auto___12825 = (0);
while(true){
if((i__7480__auto___12825 < len__7479__auto___12824)){
args__7486__auto__.push((arguments[i__7480__auto___12825]));

var G__12826 = (i__7480__auto___12825 + (1));
i__7480__auto___12825 = G__12826;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12822){
var G__12823 = cljs.core.first.call(null,seq12822);
var seq12822__$1 = cljs.core.next.call(null,seq12822);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12823,seq12822__$1);
});
...
break;
default:
var G__12830 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12830;
continue;
...
var n__7319__auto___12833 = a.length;
var i_12834 = (0);
while(true){
if((i_12834 < n__7319__auto___12833)){
(a[i_12834] = reagent.impl.template.as_element.call(null,(a[i_12834])));
...
var a = cljs.core.into_array.call(null,s);
var n__7319__auto___12836 = a.length;
var i_12837 = (0);
while(true){
if((i_12837 < n__7319__auto___12836)){
var val_12838 = (a[i_12837]);
if((cljs.core.vector_QMARK_.call(null,val_12838)) && ((reagent.impl.template.key_from_vec.call(null,val_12838) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12837] = reagent.impl.template.as_element.call(null,val_12838));

var G__12839 = (i_12837 + (1));
i_12837 = G__12839;
continue;
} else {
}
...
var ctx = ({});
var vec__12843 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12843,(0),null);
var derefed = cljs.core.nth.call(null,vec__12843,(1),null);
...
var G__12847 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12847) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12847){
