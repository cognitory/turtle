 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__20593){
var vec__20597 = p__20593;
var tag = cljs.core.nth.call(null,vec__20597,(0),null);
var re = cljs.core.nth.call(null,vec__20597,(1),null);
return ((function (vec__20597,tag,re){
return (function (s){
...
args__7486__auto__.push((arguments[i__7480__auto___20603]));
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__7487__auto__);
});
...
return p1__20600_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq20601){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20601));
});
...
var map__20608 = temp__4655__auto__;
...
var tag = cljs.core.get.call(null,map__20608__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__20608__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__20608__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__20611 = cljs.core.subs.call(null,s1,size);
var G__20612 = [cljs.core.str(s2),cljs.core.str((function (){var G__20610 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__20610) {
case "l-brace":
return "}";
